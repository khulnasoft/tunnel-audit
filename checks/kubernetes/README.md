...
```
wget https://github.com/khulnasoft/tunnel-audit/raw/main/lib/kubernetes/kubernetes.rego
wget https://github.com/khulnasoft/tunnel-audit/raw/main/lib/kubernetes/utils.rego
wget https://github.com/khulnasoft/tunnel-audit/raw/main/checks/kubernetes/pss/baseline/1_host_ipc.rego
```
3. Download an example of a non-compliant kubernetes deployment (in yaml format) 
```
wget https://github.com/khulnasoft/tunnel-audit/raw/main/test/testdata/kubernetes/KSV008/denied.yaml
```
...
The REGO rules are available [here](https://github.com/khulnasoft/tunnel-audit/tree/main/checks/kubernetes/policies/pss)
...
Additional REGO rules available [here](https://github.com/khulnasoft/tunnel-audit/tree/main/checks/kubernetes/policies/advanced/optional)
